...
type DLQPolicy struct {
	...
	// Name of the DLQ topic where the failing messages will be sent.
	Topic string
}
...
type ConsumerOptions struct {
	...
	// For Tencent TDMQ tag to filter message by topic tags
...
type Consumer interface {
	...
	// Reconsume a message
	ReconsumeLater(message Message, options ReconsumeOptions) error

	// Reconsume a message Async
	ReconsumeLaterAsync(message Message, options ReconsumeOptions, callback func(MessageID, *ProducerMessage, error))
