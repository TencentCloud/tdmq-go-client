...
func (c *connection) doHandshake() bool {
	...
	if c.authCloud != nil {
		...
		c.authCloud.CreateAuthMetadata("connect", metaMap)
		...
		if err == nil {
			...
			cmdConnect.OriginalPrincipal = &metaJsonStr
		}
		authMethodName := c.authCloud.GetAuthMethodName()
		cmdConnect.OriginalAuthMethod = &authMethodName
	}
