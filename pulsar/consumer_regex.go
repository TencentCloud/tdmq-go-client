...
func (c *regexConsumer) ReconsumeLater(message Message, options ReconsumeOptions) error {
	return errors.New("Regex topic consumer not support reconsume! ")
}

func (c *regexConsumer) ReconsumeLaterAsync(message Message, options ReconsumeOptions, callback func(MessageID, *ProducerMessage, error)) {
